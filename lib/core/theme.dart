...
class AppTextStyles {
  ...
  static const h1 = TextStyle(fontSize: 22, fontWeight: FontWeight.w700,
      color: AppColors.gray900, letterSpacing: -0.3);
  static const h2 = TextStyle(fontSize: 18, fontWeight: FontWeight.w700,
      color: AppColors.gray900);
  static const h3 = TextStyle(fontSize: 15, fontWeight: FontWeight.w600,
  ...
  static const captionBold = TextStyle(fontSize: 12, fontWeight: FontWeight.w700,
      color: AppColors.gray600, letterSpacing: 0.6);
  static const mono = TextStyle(fontSize: 13, fontFamily: 'monospace',
      color: AppColors.gray600);
  static const huge = TextStyle(fontSize: 40, fontWeight: FontWeight.w900,
      color: AppColors.teal600);
}

// ─────────────────────────────────────────────────────────────
//  AppTheme  –  single class, both light & dark inside it
// ─────────────────────────────────────────────────────────────
class AppTheme {
  // ── Light ──────────────────────────────────────────────────
